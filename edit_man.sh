...
TERMINFO="/home/funera1/repo/ncurses-6.1/build/share/terminfo"
...
(*.[0-9]*)
	...
	if test ! -f /home/funera1/repo/ncurses-6.1/man_alias.sed ; then
cat >>/home/funera1/repo/ncurses-6.1/man_alias.sed <<-CF_EOF2
		s,@DATADIR@,$datadir,g
...
s,@TSET@,tset,g
CF_EOF2
		echo "...made /home/funera1/repo/ncurses-6.1/man_alias.sed"
	fi
	...
	aliases=`sed -f $top_srcdir/man/manlinks.sed $inalias |sed -f /home/funera1/repo/ncurses-6.1/man_alias.sed | sort -u; test $inalias = $nCurses && echo curses`
	cf_target=`grep "^$cf_source" /home/funera1/repo/ncurses-6.1/man/man_db.renames | mawk '{print $2}'`
	...
	sed	-f /home/funera1/repo/ncurses-6.1/man_alias.sed \
		< $i | sed -f /home/funera1/repo/ncurses-6.1/edit_man.sed >$TMP
